#!/bin/bash
# Create clusterip CIS config
printf "##############################################\n"
printf "Create clusterip CIS config\n"
printf "##############################################\n\n\n"
kubectl apply -f f5-cis-clusterip.yaml -n kube-system
printf "\n\n##############################################\n"
...
printf "\n\n##############################################\n"
printf "Create clusterip deployment, service, configmap\n"
printf "##############################################\n\n\n"
